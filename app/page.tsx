    ...
    <main className="min-h-screen bg-neutral-50">
      ...
      <section className="bg-gradient-to-r from-teal-400 via-cyan-500 to-blue-500 text-white">
        <div className="mx-auto max-w-7xl px-6 py-20 text-center">
          <h1 className="text-4xl font-bold md:text-5xl">Handcrafted Haven</h1>
          <p className="mt-4 text-lg">Support independent artisans and find unique, handmade supplies</p>
      ...
      <footer className="border-t border-neutral-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-8 text-center">
          <p className="text-sm text-neutral-600">© 2026 Handcrafted Haven. Supporting artisans and handmade creations.</p>
